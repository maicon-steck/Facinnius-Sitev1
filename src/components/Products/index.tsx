...
import catalogo from '../../../public/documents/catalogoBR.pdf'
...
export default function Products({ productEn, productBr }) {
  ...
  return (
    <section className="products section " id="products">
      <div className="products__logosvg">
        <Image src={LogoSvg} width={974} height={974} />
      </div>

      <div className="products__titleArea container">
        <h2 className="section__titleSpecialty">{t('home_produtos')}</h2>
        <Link
          href={
            i18n.language === 'en'
              ? '/documents/catalogoUS.pdf'
              : '/documents/catalogoBR.pdf'
          }
        >
          <a className="buttonDefault specialty__button" target="_blank">
            {t('home_pdf_path')}
          </a>
        </Link>
      </div>
      ...
      <div className="products__container container swiper">
        <div className="swiper-wrapper">
          <div className="divNone" style={{ display: 'none', opacity: 0 }}>
            <Image src={blog1} alt="testeImage" className="products__img" />
            <Image src={blog2} alt="testeImage" className="products__img" />
            <Image
            ...
            <Image src={item1} alt="testeImage" className="products__img" />
            <Image src={item2} alt="testeImage" className="products__img" />
            <Image src={item1_1} alt="testeImage" className="products__img" />
            <Image src={item2_1} alt="testeImage" className="products__img" />
            <Image src={item2_2} alt="testeImage" className="products__img" />
            <Image src={item3} alt="testeImage" className="products__img" />
            <Image src={item3_1} alt="testeImage" className="products__img" />
            <Image src={item4} alt="testeImage" className="products__img" />
            <Image src={item4_1} alt="testeImage" className="products__img" />
            <Image src={item5} alt="testeImage" className="products__img" />
            <Image src={item5_1} alt="testeImage" className="products__img" />
            <Image src={item6} alt="testeImage" className="products__img" />
            <Image src={item8} alt="testeImage" className="products__img" />
            <Image src={item8_1} alt="testeImage" className="products__img" />
            <Image src={item8_2} alt="testeImage" className="products__img" />
            <Image src={item9} alt="testeImage" className="products__img" />
            <Image src={item10} alt="testeImage" className="products__img" />
            <Image src={item11} alt="testeImage" className="products__img" />
            <Image src={item12} alt="testeImage" className="products__img" />
            <Image src={item13} alt="testeImage" className="products__img" />
            <Image src={item13_1} alt="testeImage" className="products__img" />
            <Image src={item14} alt="testeImage" className="products__img" />
            <Image src={item14_1} alt="testeImage" className="products__img" />
            <Image src={item15} alt="testeImage" className="products__img" />
            <Image src={item16} alt="testeImage" className="products__img" />
            <Image src={item17} alt="testeImage" className="products__img" />

            <Image src={item18} alt="testeImage" className="products__img" />
            <Image src={item19} alt="testeImage" className="products__img" />
            <Image src={item20} alt="testeImage" className="products__img" />

            <Image src={item21} alt="testeImage" className="products__img" />

            <Image src={item22} alt="testeImage" className="products__img" />
            <Image src={item23} alt="testeImage" className="products__img" />
            <Image src={item23} alt="testeImage" className="products__img" />
            <Image src={item24} alt="testeImage" className="products__img" />
            <Image src={item25} alt="testeImage" className="products__img" />
            <Image src={item26} alt="testeImage" className="products__img" />
            <Image src={item27} alt="testeImage" className="products__img" />
            ...
            <Image src={item34} alt="testeImage" className="products__img" />

            <Image src={item35} alt="testeImage" className="products__img" />
            <Image src={item35_1} alt="testeImage" className="products__img" />
            <Image src={item36} alt="testeImage" className="products__img" />
            <Image src={item36_1} alt="testeImage" className="products__img" />
            <Image src={item37} alt="testeImage" className="products__img" />

            <Image src={item37_1} alt="testeImage" className="products__img" />
            <Image src={item38} alt="testeImage" className="products__img" />
        ...
        >
          ...
          >
            <i className="ri-arrow-right-line" style={{ cursor: 'pointer' }}>
              <BiLeftArrowAlt />
            </i>
          </div>
          ...
          >
            <i className="ri-arrow-left-line" style={{ cursor: 'pointer' }}>
              <BiRightArrowAlt />
            </i>
          </div>
        </div>
