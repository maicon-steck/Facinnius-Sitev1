        ...
        >
          {/* <div className="titulo-bg">
            <div className="titulo container">
              <p className="font-2-l-b cor-1">{t('contato_titulo')}</p>
              <h1
                dangerouslySetInnerHTML={{ __html: t('contato_subtitulo') }}
                className="font-1-xxl cor-0"
              />
            </div>
          </div> */}

          <div className="section__titleSpecialty container">
            {t('contato_titulo')}
          </div>
          ...
          <div className="orcamento container">
            <div className="orcamento-produto">
              <div className="orcamento-conteudo" id="orcamento-bikcraft">
                <h2 className="font-1-xs cor-1">{t('contato_tipo_contato')}</h2>
            ...
            <form onSubmit={handleSubimit}>
              <div className="orcamento-dados form">
                <h2 className="font-1-xs cor-9 col-2">
                  {t('contato_form_titulo')}
                </h2>
                <div className="col-2">
                ...
                {typeForm === 'contato' && (
                  <>
                    ...
                    <div>
                      <label htmlFor="cabeleireiro">
                        {t('contato_form_cabeleireiro')}
                      </label>
                      <select
                        value={formData.cabeleireiro}
                        id="cabeleireiro"
                        name="cabeleireiro"
                        onChange={handleSelectChange}
                      >
                        <option value="0">
                          {t('filtro_questao3_option0')}
                        </option>
                        <option value="sim">
                          {t('contato_form_cabeleireiro_option1')}
                        </option>
                        <option value="nao">
                          {t('contato_form_cabeleireiro_option2')}
                        </option>
                      </select>
                    </div>
                  </>
                  ...
                  <>
                    <div className="col-2">
                      ...
                      >
                        ...
                        <option value="site">
                          {t('contato_form_categoria_option1')}
                        </option>
                        <option value="produtos">
                          {t('contato_form_categoria_option2')}
                        </option>
                        <option value="produtos">
                          {t('contato_form_categoria_option3')}
                        </option>
                        <option value="elogios">
                          {t('contato_form_categoria_option4')}
                        </option>
                        <option value="duvidas">
                          {t('contato_form_categoria_option5')}
                        </option>
                        <option value="sugestoes">
                          {t('contato_form_categoria_option6')}
                        </option>
                      </select>
                    </div>
                  </>
                ...
                {typeForm !== 'distribuidor' && (
                  <div className="col-2">
                    <label
                      htmlFor={typeForm === 'opiniao' ? 'opiniao' : 'mensagem'}
                    >
                      {typeForm === 'opiniao'
                        ? t('contato_form_cidade')
                        : t('contato_form_opinião')}
                    </label>
                    <textarea
                      value={
                        typeForm === 'opiniao'
                      ...
                      name={typeForm === 'opiniao' ? 'opiniao' : 'mensagem'}
                      id={typeForm === 'opiniao' ? 'opiniao' : 'mensagem'}
                      onChange={handleTextareaChange}
                    />
                  </div>
                )}

                <button className="buttonDefault col-2">
                  {t('contato_form_enviar')}
                </button>
              </div>
            </form>
          </div>
