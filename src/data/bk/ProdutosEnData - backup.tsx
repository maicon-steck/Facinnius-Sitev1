...
export const ProdutosEnData = [
  {
    ...
    descricao:
      'Ideal for chemically damaged hair, it contains more than 20 moisturizing actives.  It acts as a mass replacement treatment (MRT), contains 14 amino acids, in addition to hydrolyzed keratin, contains D-panthenol, water-soluble noble silicones, natural polymers, in addition to hydrolyzed vegetables.',
    filtros: ['HomeCare'],
...

  {
    ...
    descricao:
      'It contains cupuaçu butter, vitamins A and E to promote water balance, hydration and healthy growth for the hair.  The Cupuaçu Facinnius Recovery Mask is excellent for the treatment of dry, fragile and chemically damaged hair, as it acts deeply on the cuticle, revitalizing the hair.',
    filtros: ['HomeCare'],
    versões: 'Version: Fl.oz 8,81  – Home Care',
    colecao: [item2],
    imagem: item2
...

  {
    ...
    descricao:
      'It contains noble silicones, amino acids, rosemary, juá zest, mallow and aloe. Perfect solution for dull hair, as it provides the hair a diamond shine.  A legitimate varnish bath rich in silicones and amino acids that nourish, hydrate and stimulate hair growth, leaving it silky and soft.',
    filtros: ['HomeCare'],
    versões: 'Version: Fl.oz 8,81  – Home Care',
    colecao: [item3],
    imagem: item3
...

  {
    ...
    descricao:
      'It contains a blend of keratin amino acids, nutrients and proteins that provide benefits such as shine, hydration, silkiness, helping to control volume and frizz.',
    filtros: ['Profissional'],
...

  {
    ...
    descricao:
      'Violeta Seda Protein Facinnius acts on two important factors for bleached hair: uniform color and hydration.  Its nanotechnological pigments remove the yellowness of the blonde strands, giving the hair a platinum appearance.  In addition, it moisturizes and provides more elasticity to the wires.',
    filtros: ['HomeCare'],
...

  {
    ...
    descricao:
      'It promotes a complete cleaning of the hair, opening the cuticles to  receive the new treatment.',
    filtros: ['Profissional'],
    versões: 'Version: Fl.oz 33,81 - Professional',
    colecao: [item9],
    imagem: item9
...

  {
    ...
    descricao:
      'Essential Therapy Facinnius acts in the cauterization, reconstruction and treatment of the scalp.  In cauterization, its formula with D-panthenol and amino acids seals the cuticles, leaving the hair with more shine and vitality.  The reconstruction has a nourishing mask based on grapeseed oil, which, being a powerful antioxidant, provides more hydrated, reconstructed and soft hair.  Already in the scalp treatment phase, its formula based on vitamin E, rosemary and mint, cleans and soothes irritations from chemical residues, controlling oiliness and the appearance of dandruff.',
    filtros: ['Profissional'],
    versões: 'Version: Fl.oz 8,45 | Fl.oz 33,81 - Professional',
    colecao: [item15],
    imagem: item15
...

  {
    ...
    descricao:
      'Ideal for mixed hair, it provides hydration and intense shine to the strands.  It keeps the hair hydrated and replenishes fiber vitamins.  It has antioxidant action, preserving the health and structure of the hair.',
    filtros: ['HomeCare'],
...

  {
    ...
    descricao:
      'Ideal for oily hair, it has detoxifying and refreshing components.  It works by balancing the oiliness of the scalp, providing hydration to the strands without weighing them down.',
    filtros: ['HomeCare'],
    versões: 'Version: Fl.oz 10,14 – Home Care',
    colecao: [item18],
    imagem: item18
...

  {
    ...
    descricao:
      'Ideal for chemically treated hair, Recovery Cupuaçu Facinnius has Biorestore and Poliquartenium 10, ingredients that moisturize, condition and repair damaged hair. It can be used after relaxation and discoloration, helping to rebuild the hair fiber.',
...

  {
    ...
    descricao:
      'The Facinnius effect liss kit promotes a prolonged smooth effect for the hair. It has high molecular nano technology ideal for hair with progressive and chemically treated. Its formula seals the hair cuticles, deeply repairing the hair fiber, in addition to controlling the volume and aligning the hair.',
    filtros: ['Profissional'],
...

  {
    ...
    descricao:
      'With a detoxifying formula, Detox Refresh Facinnius promotes an anti-pollution action, leaving a pleasant sensation of freshness and lightness. It can be used daily to balance the oiliness of the hair and scalp.',
    filtros: ['HomeCare', 'Profissional'],
    versões: 'Version: Fl.oz 10,14 – Home Care/Professional',
    colecao: [item21],
    imagem: item21
...

  {
    ...
    descricao:
      'Argan Facinnius oil is a powerful repairer, has high levels of essential fatty acids, omega 6 and vitamins A, De E. Improving the elasticity of the hair providing diamond shine and prolonged softness.',
    filtros: ['Profissional'],
...

  {
    ...
    descricao:
      'Rich in amino acids, antioxidants and lipids, the repairer Ojon Facinnius presents an ideal formula for very dry and deeply damaged hair, as it acts on the fiber recovering hair cells.  It guarantees shine and resistance to the hair , preventing it  from becoming brittle and opaque.',
    filtros: ['Profissional'],
    versões: 'Version: Fl.oz 3,84 - Professional',
    colecao: [item29_1],
    imagem: item29_1
...

  {
    ...
    descricao:
      'Produced with the best silicones on the market, the repairer Silicones Nobres Facinnius moisturizes the hair and has a protective action against external agents. It enhances the shine of the hair leaving it light and disciplined.',
    filtros: ['Profissional'],
    versões: 'Version: Fl.oz 3,84 - Professional',
    colecao: [item30_1],
    imagem: item30_1
...

  {
    ...
    descricao:
      'Facinnius Curl Activator features a unique formula that shapes, nourishes and moisturizes curls.  It has a UVA filter for extra protection against damage caused by the sun s rays.  Indicated for all types of curls and waves, it also keeps hair disciplined, with movement and protected daily.',
    filtros: ['HomeCare'],
    versões: 'Version: Fl.oz 10,14 – Home Care',
    colecao: [item31],
    imagem: item31
  ...
  },
  {
    ...
    descricao:
      'Its special formula rich in nutrients, vitamins, amino acids and silicones, is indicated for the protection of swimming  in the sea and  pool.  Protects the hair from chlorine, salt water and the sun, leaving your hair soft, with intense shine and easy to comb.',
    filtros: ['HomeCare'],
    versões: 'Version: Fl.oz 10,14 – Home Care',
    colecao: [item32],
    imagem: item32
  ...
  },
  {
    ...
    descricao:
      'Reducer Bio Elixir Facinnius contains essential oils that act on the silkiness and hydration of the hair.  It has vitamins and nano-technological assets that replace proteins and lipids, leaving healthy hair hydrated and soft.',
    filtros: ['HomeCare'],
    versões: 'Version: Fl.oz 10,14 – Home Care',
    colecao: [item34],
    imagem: item34
...

  {
    ...
    descricao:
      'Amora Shampoo with Pomegranate Facinnius, was developed with a special formula, helping in the treatment of hair, protecting, hydrating and with a lot of shine for much longer. Yields more than 330 applications. Exclusive for washbasins.',
    filtros: ['Profissional'],
  ...
  },
  {
    ...
    descricao:
      'The Blackberry Conditioner with Pomegranate Facinnius, was developed with a special formula, helping in the treatment of hair, protecting and hydrating for much longer. Yields more than 330 applications. Exclusive for washbasins.',
    filtros: ['Profissional'],
    versões: 'Version: Fl.oz 169,07 - Professional',
    colecao: [item35_1],
    imagem: item35_1
...

  {
    ...
    descricao:
      'The Cupuaçu Facinnius Recovery Shampoo, has a special formula, leaving your hair light and loose, returning its natural shine. Yields more than 330 applications. Exclusive for washbasins.',
    filtros: ['Profissional'],
    versões: 'Version: Fl.oz 169,07 - Professional',
    colecao: [item36],
    imagem: item36
  },
  {
    ...
    descricao:
      'The Conditioner Recovery Cupuaçu Facinnius, has a special formula, leaving your hair light and loose, returning the natural shine. Yields more than 330 applications. Exclusive for washbasins.',
    filtros: ['Profissional'],
    versões: 'Version: Fl.oz 169,07 - Professional',
    colecao: [item36_1],
    imagem: item36_1
...

  {
    ...
    descricao:
      'The Blueberry Shampoo with Semi de Lino Facinnius, has a special formula, rich in nutrients and vitamins, leaving your hair hydrated, soft and revitalized with intense shine. Yields more than 330 applications. Exclusive for washbasins.',
    filtros: ['Profissional'],
    versões: 'Version: Fl.oz 169,07 - Professional',
    colecao: [item37],
    imagem: item37
  },
  {
    ...
    descricao:
      'The Blueberry Conditioner with Semi de Lino, has a special formula, rich in nutrients and vitamins, leaving your hair hydrated, soft and revitalized with intense shine. Yields more than 330 applications. Exclusive for washbasins.',
    filtros: ['Profissional'],
    versões: 'Version: Fl.oz 169,07 - Professional',
    colecao: [item37_1],
    imagem: item37_1
...

  {
    ...
    descricao:
      'Mint Shampoo with Mallow Facinnius was developed in a special formula that also has antioxidant properties, keeping the strands hydrated and protected for longer. Yields more than 330 applications. Exclusive for washbasins.',
    filtros: ['Profissional'],
    versões: 'Version: Fl.oz 169,07 - Professional',
    colecao: [item38],
    imagem: item38
  },
  {
    ...
    descricao:
      'The Mint Conditioner with Mallow Facinnius, was developed in a special formula that also has antioxidant properties, keeping the strands hydrated and protected for longer. Yields more than 330 applications. Exclusive for washbasins.',
    filtros: ['Profissional'],
    versões: 'Version: Fl.oz 169,07 - Professional',
    colecao: [item38_1],
    imagem: item38_1
...

  {
    ...
    descricao:
      'SHAMPOO CRISTAL FACINNIUS - It has an exclusive formula that provides clean, hydrated, soft strands with a differentiated shine, perfect for all types of hair, even the most fragile ones. Yields more than 330 applications. Exclusive for washbasins.',
    filtros: ['Profissional'],
    versões: 'Version: Fl.oz 169,07 - Professional',
    colecao: [item39],
    imagem: item39
